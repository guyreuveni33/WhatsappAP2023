...
function ModalScreen({ handleAddContact }) {
    ...
    const handleAddClick = () => {
        if (name) {
            ...
            // Calling the parent component's handleAddContact function with the new contact object and resetting the name input field
            handleAddContact(newContact);
            setName('');
        }
    };

    // Rendering the modal with the name input field, Add and Close buttons, and associated handlers
    return (
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="modal-content">
                    ...
                    <div className="modal-footer">
                        ...
                        <button type="button" className="btn btn-primary" onClick={handleAddClick} data-bs-dismiss="modal">
                            Add
                        </button>
